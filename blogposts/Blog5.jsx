...
export default function Blog5() {
    return (
        <div className="blog">
        <br/>
        <h1>How is Technology changing the world today ?</h1>
        <br/>
        <center>
        <img id="ab" src="https://static1.makeuseofimages.com/wordpress/wp-content/uploads/2014/09/tech-change-world.jpg?q=50&fit=contain&w=767&h=384&dpr=1.5" alt=""/>
        </center>
        <br/><br/>
        <ul>Over the years, technology has revolutionized our world and daily lives. Additionally, technology for seniors has created amazing tools and resources, putting useful information at our fingertips.
<br/>
...
<ul type="circle"><h2><u>Why is Technology important?</u> </h2>
<br/>
...
<ul>Technology has also given us brand new devices in recent decades, like smartwatches, tablets, and voice assistant devices. With these devices, we can do things like transfer money instantly and make purchases for everything from clothes, food delivery, groceries, furniture, and more. Technology has changed how we entertain ourselves, meet each other, and consume all types of media. It’s made fun advancements, but it’s also made important advancements in safety when it comes to home security and medical devices.</ul>
<br/><br/>
<ul><h2><u> Those struggling with hearing loss can now benefit from TV Listening Devices that allow them to comfortably listen to their favorite programs with ease. </u> </h2>
<br/>
...
<ul>Since there are so many new technologies to keep track of, it can seem overwhelming to adapt. However, all of these new technologies are designed to make your life easier. Even though it may not feel intuitive, learning how to use smart phones, smartwatches and voice assistants just takes a little bit of instruction and practice.</ul>
<br/><br/>
<ul> <h2><u>When it comes to the way we communicate overall, modern technology has had a powerful influence.</u></h2>
<br/>
...
<ul>Technology Has Changed How We Communicate
