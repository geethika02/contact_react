...
export default function Blog2() {
    return (
        <div className="blog">
            <br/>
            <h1>Top Programming Sites to CODE ?</h1>
            <br/>
            <center>
            <img id="ab" src="https://images.unsplash.com/photo-1587620962725-abab7fe55159?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1331&q=80" alt=""/>
            </center>
            <br/><br/>
            <ul>10 Best Free Websites To Learn Programming !
...
<ul type="circle"><h2><u>1. HackerRank</u> </h2>
<br/>
...
<ul>It offers numerous programming languages for coding enthusiasts to learn more and invest their time. HackerRank is probably the best website for you to get hired by a company. The majority of the coding interviews are conducted successfully on these websites.</ul>
<br/><br/>
<ul><h2><u> 2. freeCodeCamp </u> </h2>
<br/>
...
<ul>To list some of their fabulous content published on the internet would include interactive learning web platforms for practicing web development using programming languages such as HTML, CSS, and JavaScript. </ul>
<br/><br/>
<ul> <h2><u>3. GeeksforGeeks </u></h2>
<br/>
...
<ul>Users can discuss project details with peers and mentors and share their code to receive feedback.</ul>
<br/><br/>
<ul> <h2><u>6. HackerEarth </u> </h2>
<br/>
...
<ul>W3Schools offers some of the best resources for developers to learn content for free. It has a documentation-style approach for providing information along with useful interactive code blocks, which you can click the “try it yourself” button and explore these options.</ul>
<br/><br/>
<ul> <h2><u>8. Programming Medium Platforms </u></h2>
<br/>
...
<br/><br/>
<ul> <h2><u>9. YouTube</u> </h2>
<br/>
While all the other resources mentioned in this article contain mostly theoretical articles and practical guides, it is always a good idea to explore your thoughts and learn more through visuals and images, especially in the form of videos.
</ul>

<ul>YouTube is one such platform that is home to tons of free programming and coding content that will allow its viewers to learn and intuitively code alongside the runtime of the video.
</ul>
<ul>
My personal recommendation for some of the best YouTube videos to learn to program and improve your coding skills.
</ul>
<br/><br/>
<ul><h2> <u>10. GitHub and Stack Overflow </u> </h2>
<br/>
...
<ul>“In some ways, programming is like painting. You start with a blank canvas and certain basic raw materials. You use a combination of science, art, and craft to determine what to do with them.” — Andrew Hunt</ul>
<br/><br/>
<Contact/>
        </div>
    )
